...
try:
    ...
    version = release = __import__('{{ project_name }}').get_version()
except:
...
latex_documents = [
  ('index', 'KTech.tex', u'{{ project_name }} Documentation',
   u'K-Tech', 'manual'),
]
...
epub_author = u'K-Tech'
epub_publisher = u'K-Tech'
epub_copyright = u'2012, K-Tech'
